...
#define pinBtTx        7  //Definir o pin TX (pin de comunicação)- "Cabo" vd
...
//int velocidade = 0; // *Não utilizada no código* Guarda o valor da velocidade na condição falsa = > Velocidade dele é nula (0)/Parada
//bool sentido = 1; // *Não utilizada no código* Verdadeira 
//int estado = 0; // *Não utilizada no código* Guarda valor do estado na condição falsa = > Estado inicial dele é parado (0)
